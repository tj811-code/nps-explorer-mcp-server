/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0db1b89cb047666b58687666a76c8061)
// Runtime types generated with workerd@1.20260212.0 2025-02-04 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./mcpServer");
		durableNamespaces: "NpsMcpAgent";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		NpsMcpAgent: DurableObjectNamespace<import("./mcpServer").NpsMcpAgent>;
	}
}
